 ...
 */
public class FurLinedChainJacket implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(FurLinedChainJacket.class.getName());
    public static int templateId;
    private String name = "Cozy chain jacket";
    public void createTemplate() throws IOException {
        /*        createItemTemplate(276, 3, "chain jacket", "chain jackets", "excellent", "good", "ok", "poor",
         *"A heavy jacket made from metal chain.", new short[]{108, 44, 22, 4, 189, 147}, (short)1040, (short)1, 0, 3024000L, 3, 35, 40, -10, new byte[]{2},
         * "model.armour.torso.chain.", 65.0F, 2200, (byte)0, 10000, true, 3);
         */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.furlinedchainjacket");
        itemBuilder.name(name, "Cozy chain jackets", "A heavy jacket made from metal chain, lined with cozy fur.");
        ...
        itemBuilder.imageNumber((short) 1040);
        itemBuilder.behaviourType((short) 1);
        itemBuilder.combatDamage(0);
        itemBuilder.decayTime(3024000L);
        itemBuilder.dimensions(3, 35, 40);
        itemBuilder.primarySkill(-10);
        itemBuilder.bodySpaces(new byte[]{2});
        itemBuilder.modelName("model.armour.torso.chain.");
        itemBuilder.difficulty(65.0f);
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.CLOTHTAILORING, ItemList.fur, ItemList.chainJacket,
