package org.yggdrasil.wurmunlimited.mods.Items.Weapons.heads;
...
public class CurvedDaggerBlade implements ItemTypes, MiscConstants {
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			//example of omultiple different blade types that can be made. So multiple easy templates for a single item.
